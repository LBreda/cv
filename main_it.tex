...
\begin{itemize}
\item Progettazione e sviluppo di una serie di software per la logistica di costruzione e gestione di linee metropolitane. Tali software sono utilizzati per diverse linee metropolitane in tutto il mondo (Roma, Milano, Copenaghen, Aarhus, Riyadh, Lima).
